...
alter table "public"."Participacion" enable row level security;

CREATE UNIQUE INDEX participacion_pkey ON public."Participacion" USING btree (id);

alter table "public"."Participacion" add constraint "participacion_pkey" PRIMARY KEY using index "participacion_pkey";

alter table "public"."Participacion" add constraint "participacion_jugador_id_fkey" FOREIGN KEY (jugador_id) REFERENCES public."Socios"(id) not valid;

alter table "public"."Participacion" validate constraint "participacion_jugador_id_fkey";

alter table "public"."Participacion" add constraint "participacion_partido_id_fkey" FOREIGN KEY (partido_id) REFERENCES public."Partidos"(id) not valid;

alter table "public"."Participacion" validate constraint "participacion_partido_id_fkey";

alter table "public"."Participacion" add constraint "participacion_sustituto_id_fkey" FOREIGN KEY (sustituto_id) REFERENCES public."Socios"(id) not valid;

alter table "public"."Participacion" validate constraint "participacion_sustituto_id_fkey";
...
grant delete on table "public"."Participacion" to "anon";

grant insert on table "public"."Participacion" to "anon";

grant references on table "public"."Participacion" to "anon";

grant select on table "public"."Participacion" to "anon";

grant trigger on table "public"."Participacion" to "anon";

grant truncate on table "public"."Participacion" to "anon";

grant update on table "public"."Participacion" to "anon";

grant delete on table "public"."Participacion" to "authenticated";

grant insert on table "public"."Participacion" to "authenticated";

grant references on table "public"."Participacion" to "authenticated";

grant select on table "public"."Participacion" to "authenticated";

grant trigger on table "public"."Participacion" to "authenticated";

grant truncate on table "public"."Participacion" to "authenticated";

grant update on table "public"."Participacion" to "authenticated";
...
grant delete on table "public"."Participacion" to "service_role";

grant insert on table "public"."Participacion" to "service_role";

grant references on table "public"."Participacion" to "service_role";

grant select on table "public"."Participacion" to "service_role";

grant trigger on table "public"."Participacion" to "service_role";

grant truncate on table "public"."Participacion" to "service_role";

grant update on table "public"."Participacion" to "service_role";
