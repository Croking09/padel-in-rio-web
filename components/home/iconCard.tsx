...
export default function IconCard({ title, subtitle, icon }: IconCardProps) {
  return (
    <div className="aspect-square h-36 pt-2 pb-4 gap-2 rounded-2xl inline-flex flex-col items-center justify-center bg-primary shadow-[10px_10px_10px_rgba(0,0,0,0.25)]">
